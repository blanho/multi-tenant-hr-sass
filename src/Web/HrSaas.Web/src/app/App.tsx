import { CircularProgress, CssBaseline, LinearProgress, Stack } from "@mui/material";
...
const NotificationTemplatesPage = lazy(() => import("@/features/notifications/NotificationTemplatesPage").then((m) => ({ default: m.NotificationTemplatesPage })));
